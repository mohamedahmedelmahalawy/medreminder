			...
			<header className='bg-white shadow-sm border-b border-gray-200 px-6 py-4'>
				<div className='flex items-center justify-between'>
					<div>
						...
						<p className='text-gray-600'>Stay on top of your patient schedule.</p>
						<p className='text-gray-600'>
							Total Appointments: {filteredAppointments.length} / {appointments.length}
						</p>
					</div>
				</div>
							...
							<div className='flex-1'>
								...
								<div className='grid grid-cols-2 gap-4 text-sm text-gray-600'>
									<div>
										...
										<p>
											<span className='font-medium'>Age:</span> {appointment.patientAge}
										</p>
										<p>
								...
								<div className='mt-3'>
									<p className='text-sm'>
										<span className='font-medium text-blue-600'>Diagnosis:</span>{" "}
									...
									<p className='text-sm'>
										<span className='font-medium text-orange-600'>Complaint:</span>{" "}
						...
						<div className='flex flex-col items-end space-y-3 ml-4'>
							...
							<div className='flex space-x-2'>
								<button
									...
									onClick={() => redirect(`/patients/${appointment.patientPhone}`)}
								>
									View Details
								</button>
							</div>
