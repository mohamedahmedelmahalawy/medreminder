			...
			<div className='w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
				...
				<div className='grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center'>
					...
					<div className='space-y-8'>
						<div>
							...
							<p className='text-gray-600 text-base md:text-lg leading-relaxed mb-8'>
								With a focus on compassionate and personalized treatment we strive to
								create a welcoming environment where patients feel valued respected and
								well informed about their health
							</p>
						</div>
						...
						<div className='flex flex-col sm:flex-row gap-4 pt-6 sm:pt-8'>
							{/* Read More Button */}
							<button className='group relative cursor-pointer overflow-hidden bg-blue-500 hover:bg-blue-600 text-white font-medium py-4 px-8 rounded-lg transition-all duration-300 flex items-center justify-center space-x-2'>
								<span className='relative z-10'>Read More</span>
								<div className='relative z-10 transform group-hover:translate-x-1 transition-transform duration-600'>
									<ArrowRight className='w-5 h-5' />
								</div>
								{/* Hover gradient effect */}
								<div className='absolute inset-0 bg-gradient-to-r from-[#000D44] to-blue-500 transform translate-x-full group-hover:translate-x-0 transition-transform duration-600 ease-in-out'></div>
							</button>
					...
					<div className='relative w-full'>
						...
						{/* Decorative elements */}
						<div className='hidden md:block absolute top-8 -right-4 w-16 h-16 bg-blue-200 rounded-full opacity-50'></div>
						<div className='hidden md:block absolute -top-4 left-12 w-8 h-8 bg-green-300 rounded-full opacity-60'></div>
						<div className='hidden md:block absolute bottom-16 -right-8 w-12 h-12 bg-yellow-200 rounded-full opacity-40'></div>
					</div>
				</div>
			</div>
		</div>
