...
const posts: Post[] = [
	{
		...
		desc:
			"Our well designed dashboard allows medical staff to easily track patients' medications, treatment plans, and progress. It provides a comprehensive overview of each patient's health status, ensuring that medical professionals can deliver timely and effective care.",
	},
	{
		id: "2",
		image:
		...
		title: "Notification System for Patients to Stay Updated on Their Medication",
		desc:
			"Our app features a robust notification system that keeps patients informed about their medication schedules, upcoming appointments, and any changes in their treatment plans. This ensures that patients never miss a dose and stay on top of their healthcare needs.",
	},
];
const medicalManagementPosts: MedicalManagementPost[] = [
	{
		...
		desc:
			"Our app helps medical staff by organizing patient schedules, medications, diagnoses, and prognoses—so they can focus on delivering care instead of managing files.",
	},
	{
		id: "1002",
		image:
		...
		desc:
			"Our app gives patients a clear view of their medical treatment plan, including accurate dosages prescribed by their doctor, precise timing for each medication, and upcoming visit schedules—ensuring they stay informed and on track with their care.",
	},
];
