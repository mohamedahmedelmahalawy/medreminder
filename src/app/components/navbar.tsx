          ...
          {!isLoggedIn ? (
            <>
              <Link
                ...
                className="flex-1 bg-white hover:bg-gray-100 px-3 lg:px-4 py-2 lg:py-2 border border-gray-200 rounded-xl font-semibold text-[#000D44] text-sm lg:text-base text-center transition"
              >
                Login
              </Link>
              <Link
                href="/signup"
                onClick={() => setIsClicked("")}
                className="flex-1 bg-[#4B4EFC] hover:bg-[#3737e8] px-3 lg:px-4 py-2 lg:py-2 border border-[#4B4EFC] rounded-xl font-semibold text-white text-sm lg:text-base text-center transition"
              >
                SignUp
              </Link>
            </>
