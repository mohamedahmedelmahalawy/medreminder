      ...
      <div>
        <div className="flex flex-col items-center text-center max-w-md mx-auto bg-white p-8">
          ...
          <p className="text-gray-600 mb-6">
            You don't have any upcoming appointments with your doctors. Schedule
            one to stay on track with your health.
          </p>
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Input the code in the field above and click connect to
