                          ...
                          <div className="flex items-center justify-between mb-3">
                            ...
                            <div className="text-right">
                              ...
                              <p className="text-sm font-medium text-blue-600">
                                {patient.cases?.[0]?.diagnosis?.length || 0}{" "}
                                Active Cases
                              </p>
                            </div>
                          </div>
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 shadow-lg border border-blue-100">
                      <div className="text-center">
                        ...
                        <p className="text-gray-600 max-w-md mx-auto">
                          Please wait while we fetch your connected healthcare
                          providers.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-8 shadow-lg border border-amber-100">
                      <div className="text-center">
                        ...
                        <p className="text-gray-600 mb-6 max-w-md mx-auto">
                          Connect with your healthcare providers to access your
                          medical records, schedule appointments, and stay
                          updated on your health.
                        </p>
                        <Link
                          href="/profile/code"
