...
export default function IntroStats() {
  return (
    <section aria-labelledby="intro-stats" className="bg-white py-18">
      <div className="mx-auto px-4 py-20 max-w-screen-xl">
        <div className="items-start gap-x-16 gap-y-10 grid grid-cols-1 lg:grid-cols-2">
          <div>
            <h2
              id="intro-stats"
              className="font-extrabold text-[#4b2fa9] text-5xl xl:text-6xl lg:text-left text-center tracking-tight"
            >
          ...
          <div>
            <p className="mx-auto px-2 md:px-0 w-full max-w-md md:max-w-xl text-gray-600 text-base leading-7 sm:leading-8">
            ...
            <div className="gap-6 sm:gap-10 grid grid-cols-1 sm:grid-cols-2 mx-auto mt-10 w-full max-w-md">
              <div className="sm:text-left text-center">
                <div className="font-semibold tabular-nums text-[#4B4EFC] text-4xl sm:text-5xl">
                  100%
                </div>
