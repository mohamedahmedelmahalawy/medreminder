      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="absolute right-4 top-4 rounded-xs opacity-70 transition-opacity outline-none ring-offset-background focus:ring-2 focus:ring-ring focus:ring-offset-2 hover:opacity-100 disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
          >
            <XIcon />
